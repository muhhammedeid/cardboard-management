...
Arabic-first stack: `Noto Sans Arabic`, `Noto Sans`, Tahoma, Arial, sans-serif. Font delivery is deliberately local/system fallback only: no Google Fonts runtime dependency is added. Desktop page title is 24/32, mobile 22/30; compact review section headings are 18/26; KPI value is 32/40. Spacing follows 4, 8, 12, 16, 20, 24, 32, 40, 48, 64 px. Controls use 8 px radius, cards 12 px, panels 16 px. Surfaces use hairline borders and restrained elevation.
